...
const FLOORS = [
  ...
  { key: 'appliance', cat: 8, title: '家用电器', sub: '品质生活 · 七天无理', emoji: '❄️' },
  { key: 'fashion',   cat: 4, title: '服饰鞋包', sub: '时尚百搭 · 渠道授权', emoji: '👔' },
  { key: 'beauty',    cat: 7, title: '美妆个护', sub: '全网低价 · 正品保障', emoji: '💄' },
  { key: 'food',      cat: 9, title: '食品酒水', sub: '源头直采 · 包邮到家', emoji: '🍎' },
]
      ...
      <div className="container">
        ...
        <section className="hero section">
          ...
          <div className="hero-main" style={{ backgroundImage: 'url(https://picsum.photos/seed/yzhero/760/420)', backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <h1>云智购 · 盛夏焕新</h1>
            <p>正品低价 · 极速精选 · 七天无理由退换</p>
            <button className="btn" onClick={() => nav('/products')}>立即逛逛</button>
          </div>
          <div className="hero-right">
            <Link className="box" style={{ background: 'var(--orange)', color: '#fff' }} to="/coupons">
              <div className="t">领券中心</div>
              <div className="s">新人专享 满99减30</div>
            </Link>
            <Link className="box" to="/seckill">
        ...
        <section className="section">
          <div className="section-head"><h2>全部分类</h2><span className="muted">点击进入分类速览</span></div>
        ...
        <div className="promo-strip">
          <div className="promo-item"><span className="promo-ic">券</span><span className="promo-tx">满99减30 · 新人专享</span></div>
          <div className="promo-item"><span className="promo-ic">秒</span><span className="promo-tx">限时秒杀 每日10点开抢</span></div>
          <div className="promo-item"><span className="promo-ic">白</span><span className="promo-tx">百亿补贴 · 真低价不套路</span></div>
          <div className="promo-item"><span className="promo-ic">包</span><span className="promo-tx">包邮到家 · 全场满59包邮</span></div>
        </div>

        {seckill.length > 0 && (
          <section className="section floor floor-seckill">
            <div className="section-head">
              <h2><span className="floor-tag tag-red">限时秒杀</span> 沐水价抢到就赚到</h2>
              <span className="muted">快抢 · 仅剩 4 小时</span>
            </div>
        ...
        {FLOORS.map((f) => floorData[f.key] && floorData[f.key].length > 0 ? (
      ...
      <footer className="site-footer">
        <div className="container">
          <div className="footer-cols">
            <div className="footer-col"><h4>购物指南</h4><a>注册流程</a><a>下单流程</a><a>支付方式</a><a>会员优惠</a></div>
